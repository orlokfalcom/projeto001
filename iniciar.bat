...
rem 2. Se nao tiver Node.js, verificar se a pasta estatica out existe
echo [AVISO] Node.js nao foi detectado neste sistema.
...
echo.
echo 1. O Node.js nao esta instalado neste computador.
echo 2. A pasta estatica out/ ainda nao foi gerada.
echo.
echo Para resolver isso:
echo a) Instale o Node.js nesta maquina para iniciar em modo de desenvolvimento.
